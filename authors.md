...
Leite A, Wasilew M, Vasconcelos H, Amorim C, Bezerra D (2026). *cagedr:
Access 'Novo CAGED' Microdata from the Brazilian Ministry of Labour*. R
package version 0.1.0, <https://github.com/StrategicProjects/cagedr>.
    ...
    @Manual{,
      ...
      url = {https://github.com/StrategicProjects/cagedr},
    }
